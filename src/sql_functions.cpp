...
/*
  USAGE: Creates the contacts table if it does not exist already.
    Params:
...
/*
  USAGE: Check if the contacts table is empty.
    Params:
     - db         : open sqlite3 database handle
*/
...
/*
  USAGE: Insert a new contact into the contacts table using a prepared statement.
    Params:
     - newContact : Contact struct containing the new contact's details
     - db         : open sqlite3 database handle
*/
...
/*
  USAGE: Look up a contact by name and print the details if found.
    Params:
     - db         : open sqlite3 database handle
     - contactToSeek : Contact struct containing the contact's details to seek
*/
...
/*
  USAGE: Callback function to process and print each row of the result set.
    Params:
        - unused   : unused parameter for compatibility with sqlite3_exec
        - col_n    : number of columns in the result row
        - data     : array of strings representing fields in the row
...
/*
  USAGE: Print all contacts in the contacts table.
    Params:
     - db         : open sqlite3 database handle
*/
...
/*
  USAGE: Delete a contact by id from the contacts table.
    Params:
     - db         : open sqlite3 database handle
